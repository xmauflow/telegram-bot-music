...
from cilik import Carbon, YouTube, cilik
from cilik.utils.database import (delete_playlist, get_playlist,
                                    get_playlist_names,
                                    save_playlist)
...
from cilik.utils.inline.playlist import (botplaylist_markup,
                                           get_playlist_markup,
                                           warning_markup)
from cilik.utils.pastebin import Yukkibin
        ...
        [
            [
                InlineKeyboardButton(
                    text=_["PL_B_6"],
                    url=f"https://t.me/{cilik.username}?start=delplaylists",
                ),
            ]
        ]
    )
...
@cilik.on_callback_query(filters.regex("play_playlist") & ~BANNED_USERS)
@languageCB
...
@cilik.on_callback_query(filters.regex("add_playlist") & ~BANNED_USERS)
@languageCB
...
@cilik.on_callback_query(filters.regex("del_playlist") & ~BANNED_USERS)
@languageCB
...
@cilik.on_callback_query(filters.regex("home_play") & ~BANNED_USERS)
@languageCB
