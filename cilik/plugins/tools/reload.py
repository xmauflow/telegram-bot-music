...
from cilik.utils.database import get_authuser_names, get_cmode
from cilik.utils.decorators import (ActualAdminCB, AdminActual,
                                      language)
...
@cilik.on_callback_query(filters.regex("close") & ~BANNED_USERS)
