...
from cilik.utils import (Yukkibin, get_channeplayCB,
                           seconds_to_min)
from cilik.utils.database import (get_cmode, is_active_chat,
                                    is_music_playing)
from cilik.utils.decorators.language import language, languageCB
from cilik.utils.inline import queue_back_markup, queue_markup
...
@cilik.on_callback_query(filters.regex("GetTimer") & ~BANNED_USERS)
...
@cilik.on_callback_query(filters.regex("GetQueued") & ~BANNED_USERS)
@languageCB
