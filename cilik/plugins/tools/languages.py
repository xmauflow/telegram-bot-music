...
from cilik.utils.database import get_lang, set_lang
from cilik.utils.decorators import (ActualAdminCB, language,
                                      languageCB)
...
@cilik.on_callback_query(filters.regex("LG") & ~BANNED_USERS)
@languageCB
