...
from cilik.utils.formatters import convert_bytes
from cilik.utils.inline.song import song_markup
        ...
        [
            [
                InlineKeyboardButton(
                    text=_["SG_B_1"],
                    url=f"https://t.me/{cilik.username}?start=song",
                ),
            ]
        ]
    )
