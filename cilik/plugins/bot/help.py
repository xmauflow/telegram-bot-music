...
from cilik.utils import help_pannel
from cilik.utils.database import get_lang, is_commanddelete_on
from cilik.utils.decorators.language import (LanguageStart,
                                               languageCB)
from cilik.utils.inline.help import (help_back_markup,
                                       private_help_panel)
...
@cilik.on_callback_query(filters.regex("help_callback") & ~BANNED_USERS)
@languageCB
