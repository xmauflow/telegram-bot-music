...
from cilik.misc import HAPP, SUDOERS, XCB
...
@cilik.on_message(filters.command(GETLOG_COMMAND) & SUDOERS)
@language
...
@cilik.on_message(filters.command(GETVAR_COMMAND) & SUDOERS)
@language
...
@cilik.on_message(filters.command(DELVAR_COMMAND) & SUDOERS)
@language
...
@cilik.on_message(filters.command(SETVAR_COMMAND) & SUDOERS)
@language
...
@cilik.on_message(filters.command(USAGE_COMMAND) & SUDOERS)
@language
...
@cilik.on_message(filters.command(UPDATE_COMMAND) & SUDOERS)
@language
...
@cilik.on_message(filters.command(REBOOT_COMMAND) & SUDOERS)
