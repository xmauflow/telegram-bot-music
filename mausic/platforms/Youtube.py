...
from mausic.utils.formatters import time_to_seconds
...
class YouTubeAPI:
    ...
    async def download(
        ...
        cookies_file = './mausic/ytdl.txt'  # Path to your cookies file
        ...
        def audio_dl():
            ydl_opts = {
                ...
                "quiet": True,
                "no_warnings": True,
                "cookiefile": cookies_file,  # Add this line to use cookies
            }
            x = yt_dlp.YoutubeDL(ydl_opts)
            info = x.extract_info(link, True)
