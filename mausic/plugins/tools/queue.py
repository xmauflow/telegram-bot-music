...
from mausic.utils import (Yukkibin, get_channeplayCB,
                           seconds_to_min)
from mausic.utils.database import (get_cmode, is_active_chat,
                                    is_music_playing)
from mausic.utils.decorators.language import language, languageCB
from mausic.utils.inline import queue_back_markup, queue_markup
...
@mausic.on_callback_query(filters.regex("GetTimer") & ~BANNED_USERS)
...
@mausic.on_callback_query(filters.regex("GetQueued") & ~BANNED_USERS)
@languageCB
