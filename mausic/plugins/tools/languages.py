...
from mausic.utils.database import get_lang, set_lang
from mausic.utils.decorators import (ActualAdminCB, language,
                                      languageCB)
...
@mausic.on_callback_query(filters.regex("LG") & ~BANNED_USERS)
@languageCB
