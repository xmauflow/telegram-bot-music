...
from mausic.utils.formatters import convert_bytes
from mausic.utils.inline.song import song_markup
        ...
        [
            [
                InlineKeyboardButton(
                    text=_["SG_B_1"],
                    url=f"https://t.me/{mausic.username}?start=song",
                ),
            ]
        ]
    )
