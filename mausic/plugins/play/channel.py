...
from mausic.utils.database import set_cmode
from mausic.utils.decorators.admins import AdminActual
...
async def get_admins(chat_id):
    return [admins async for admins in mausic.get_chat_members(chat_id, filter=enums.ChatMembersFilter.ADMINISTRATORS)]
...
async def playmode_(client, message: Message, _):
    ...
    if (str(query)).lower() == "disable":
        ...
        try:
            ...
            chat = await mausic.get_chat(memek)
