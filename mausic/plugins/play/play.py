...
from mausic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                     YouTube, cilik)
from mausic.core.call import Yukki
from mausic.utils import seconds_to_min, time_to_seconds
from mausic.utils.channelplay import get_channeplayCB
from mausic.utils.database import is_video_allowed
from mausic.utils.decorators.language import languageCB
from mausic.utils.decorators.play import PlayWrapper
from mausic.utils.decorators.mustjoin import subcribe

from mausic.utils.formatters import formats
from mausic.utils.inline.play import (livestream_markup,
                                       playlist_markup,
                                       slider_markup, track_markup)
from mausic.utils.inline.playlist import botplaylist_markup
from mausic.utils.logger import play_logs
from mausic.utils.stream.stream import stream
...
@mausic.on_callback_query(filters.regex("MusicStream") & ~BANNED_USERS)
@languageCB
...
@mausic.on_callback_query(filters.regex("slider") & ~BANNED_USERS)
@languageCB
