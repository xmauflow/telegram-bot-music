...
from mausic import Carbon, YouTube, mausic
from mausic.utils.database import (delete_playlist, get_playlist,
                                    get_playlist_names,
                                    save_playlist)
...
from mausic.utils.inline.playlist import (botplaylist_markup,
                                           get_playlist_markup,
                                           warning_markup)
from mausic.utils.pastebin import Yukkibin
        ...
        [
            [
                InlineKeyboardButton(
                    text=_["PL_B_6"],
                    url=f"https://t.me/{mausic.username}?start=delplaylists",
                ),
            ]
        ]
    )
...
@mausic.on_callback_query(filters.regex("play_playlist") & ~BANNED_USERS)
@languageCB
...
@mausic.on_callback_query(filters.regex("add_playlist") & ~BANNED_USERS)
@languageCB
...
@mausic.on_callback_query(filters.regex("del_playlist") & ~BANNED_USERS)
@languageCB
...
@mausic.on_callback_query(filters.regex("home_play") & ~BANNED_USERS)
@languageCB
