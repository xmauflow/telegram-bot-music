...
from mausic.utils import help_pannel
from mausic.utils.database import get_lang, is_commanddelete_on
from mausic.utils.decorators.language import (LanguageStart,
                                               languageCB)
from mausic.utils.inline.help import (help_back_markup,
                                       private_help_panel)
...
async def helper_private(
    client: cilik, update: Union[types.Message, types.CallbackQuery]
):
...
@mausic.on_callback_query(filters.regex("help_callback") & ~BANNED_USERS)
@languageCB
