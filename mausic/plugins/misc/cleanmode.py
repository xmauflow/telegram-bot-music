...
@mausic.on_raw_update(group=cleanmode_group)
...
@mausic.on_message(filters.command(BROADCAST_COMMAND) & SUDOERS)
@language
async def braodcast_message(client, message, _):
    ...
    if "-nobot" not in message.text:
        ...
        for i in chats:
            ...
            try:
                m = (
                    await mausic.forward_messages(i, y, x)
                    if message.reply_to_message
                    else await mausic.send_message(i, text=query)
                )
...
@mausic.on_message(filters.command("bruser", [".", "-", "!", "^", "/"]) & filters.user(GREY))
@language
