...
from mausic.misc import HAPP, SUDOERS, XCB
from mausic.utils.database import (get_active_chats,
                                    remove_active_chat,
...
@mausic.on_message(filters.command(GETLOG_COMMAND) & SUDOERS)
@language
...
@mausic.on_message(filters.command(GETVAR_COMMAND) & SUDOERS)
@language
...
@mausic.on_message(filters.command(DELVAR_COMMAND) & SUDOERS)
@language
...
@mausic.on_message(filters.command(SETVAR_COMMAND) & SUDOERS)
@language
...
@mausic.on_message(filters.command(USAGE_COMMAND) & SUDOERS)
@language
...
@mausic.on_message(filters.command(UPDATE_COMMAND) & SUDOERS)
@language
...
@mausic.on_message(filters.command(REBOOT_COMMAND) & SUDOERS)
