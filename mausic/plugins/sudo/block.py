...
from mausic.utils.database import add_gban_user, remove_gban_user
...
@mausic.on_message(filters.command(BLOCK_COMMAND) & SUDOERS)
@language
...
@mausic.on_message(filters.command(UNBLOCK_COMMAND) & SUDOERS)
@language
...
@mausic.on_message(filters.command(BLOCKED_COMMAND) & SUDOERS)
@language
async def sudoers_list(client, message: Message, _):
    ...
    for users in BANNED_USERS:
        try:
            user = await mausic.get_users(users)
            user = (
